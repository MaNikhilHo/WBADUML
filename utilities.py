...
def get_args():                                 #python input namilda milauna dekhaune
...
def get_data_details(csv_data):                 #features haru dekhaune
...
def get_occuracy(real_labels, predicted_labels, fltr):          #accuracy dekhauxa yesle
